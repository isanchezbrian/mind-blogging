...
import { signInWithPopup, GoogleAuthProvider, createUserWithEmailAndPassword, getAuth, signInWithEmailAndPassword, onAuthStateChanged, signInWithRedirect } from 'firebase/auth';
import { auth, app, db} from '../../utils/firebase';
import { useRouter } from 'next/router';
import { useAuthState } from 'react-firebase-hooks/auth';
import { useEffect, useState } from 'react';
import {doc, getDoc, setDoc, docRef, ref} from 'firebase/firestore'
    ...
    return(
        <div className="shadow-xl mt-30 p-10 text-gray-700 rounded-lg mb-20">
            <div className="">
                ...
                <button onClick={GoogleLogin} className="text-white bg-gray-700 w-full font-medium rounded-lg flex align-middle mb-4 p-4 gap-2 duration-300 hover:opacity-75">
